...
class LateFusionAttentionTransformer(nn.Module):
    ...
    def __init__(self, audio_dim, video_dim, pers_dim, embed_dim, nhead, num_encoder_layers,
                 ...
                 fusion_n_layers, fusion_nhead, dropout_rate=0.1):
        super().__init__()

        # We use Modality Specific CLS Tokens & Encoders 
    ...
    def forward(self, A_feat, V_feat, P_feat):
        ...
        # Passing it through fusion transformer
        fusion_out = self.fusion_transformer_encoder(fusion_input_seq) # Shape: [B, 4, D]

        # obtaining the output corresponding to the FUSION_CLS token (first position)
...
if __name__ == '__main__':
    ...
    # settings for data and features
    WINDOW_SPLIT_TIME = 1
    ...
    # settings for classification and splitting
    LABEL_COUNT = 2
    TRACK_OPTION = "Track1"
    VAL_RATIO = 0.1
    VAL_PERCENTAGE = 0.1
    ...
    FUSION_N_LAYERS = 1        # Layers for the fusion transformer 
    FUSION_NHEAD = 4           # Heads for the fusion transformer
    DROPOUT_RATE = 0.4         
    ...
    # settings for loss function and balancing
    ...
    for epoch in range(NUM_EPOCHS_FINAL):
        ...
        # code for checking for best model and saving
    ...
    # code for training completion summary
