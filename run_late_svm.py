...
if __name__ == '__main__':
    ...
    # code for creating datasets and dataloaders
    ...
    # code for extracting features for scikit-learn
    ...
    # code for training individual svms
    ...
    # code for saving trained models
    ...
    # passing already extracted validation features
    ...
    print(f"Total stored elements across all scalers and SVMs: {int(total_elements)}") 